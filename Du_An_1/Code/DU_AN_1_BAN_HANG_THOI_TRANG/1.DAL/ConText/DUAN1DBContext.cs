...
namespace _1.DAL.ConText
{
    public class DUAN1DBContext : DbContext
    {
        ...
        {
            dbContextOptionsBuilder.UseSqlServer(@"Data Source=DESKTOP-0LREL52\SQLEXPRESS;Initial Catalog=databaseDA001;Persist Security Info=True; User ID =huyendtph24484; Password =123456");
        }
