...
namespace _3.PL.View
{
    public partial class FrmQuanLySanPham : Form
    {
        ...
        {
            int stt = 1;
            dgrid_Data.ColumnCount = 11;
            dgrid_Data.Columns[0].Name = "STT";
            dgrid_Data.Columns[1].Name = "ID";
            dgrid_Data.Columns[2].Name = "Tên Sản Phẩm";
            dgrid_Data.Columns[3].Name = "NSX";
            dgrid_Data.Columns[4].Name = "Thương Hiệu";
            dgrid_Data.Columns[5].Name = "Dòng SP";
            dgrid_Data.Columns[6].Name = "Chất Liệu";
            dgrid_Data.Columns[7].Name = "Số Lượng Tồn";
            dgrid_Data.Columns[8].Name = "Gía Nhập";
            dgrid_Data.Columns[9].Name = "Gía Bán";
            dgrid_Data.Columns[10].Name = "Mô Tả";
            ...
            {     
                dgrid_Data.Rows.Add(stt++, x.ID, x.TenSP, x.TenThuongHieu, x.TenMauSac, x.TenDongSP, x.TenChatLieu, x.SoLuongTon, x.GiaNhap, x.GiaBan, x.MoTa, x.TrangThai);
            }
        }
        ...
        private void dgrid_Data_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                _id = Guid.Parse(dgrid_Data.Rows[e.RowIndex].Cells[0].Value.ToString());
